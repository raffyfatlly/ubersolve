    ...
    >
      {displayedMessages.map((msg, idx) => (
        <div
          ...
          } backdrop-blur-sm p-2.5 md:p-3 rounded-lg transition-all duration-300 text-[15px] md:text-base leading-relaxed`}
        >
      ...
      {!isTyping && currentIndex < messages.length && displayedMessages.length < messages.length * 2 && isInView && (
